...
describe("ContentChangeComponent", () => {
  ...
  describe("ngOnInit", () => {
    it("should set paragraphs with ipsums", inject(
      [IpsumService],
  ...
  describe("updateContent", () => {
    it("should set variable paragraph2 with new ipsum and call contentChange on NgxHeightToggleService", inject(
      [IpsumService],
      (service: IpsumService) => {
        component.paragraph2 = "";
        const mockIpsum = "mock ipsum text";
        spyOn(service, "getDifferentIpsum").and.returnValue(mockIpsum);
